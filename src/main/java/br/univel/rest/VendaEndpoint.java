...
public class VendaEndpoint
{
   ...
   {
      TypedQuery<Venda> findByIdQuery = em.createQuery("SELECT DISTINCT v FROM Venda v LEFT JOIN FETCH v.usuario LEFT JOIN FETCH v.itens WHERE v.id = :entityId ORDER BY v.id", Venda.class);
